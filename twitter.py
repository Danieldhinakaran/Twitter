...
def main():
    ...
    if choice == "Home":
        st.write('''This app is a Twitter Scraping web app created using Streamlit. 
             It scrapes the data from the twitter for the given hashtag or keyword for a given period of time.
             The tweets are uploaded in MongoDB and can be dowloaded as CSV or a JSON file.''')
        image = Image.open(r"C:\Users\user\Desktop\course\elon.png")
